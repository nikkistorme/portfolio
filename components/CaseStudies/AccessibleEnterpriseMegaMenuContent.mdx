...
- Advanced knowledge of WCAG, ARIA, and accessible interaction design
- Ability to solve non-standard UI problems thoughtfully
- Senior-level judgment in balancing UX, accessibility, and technical constraints
- Experience leading accessibility-critical features in real production environments
