...
- Lead-level ownership of Next.js architecture and rendering strategy
- Strong judgment around performance, SEO, and UX tradeoffs
- Ability to translate design-ready Figma work into polished, production-ready UI
- Experience setting frontend standards and mentoring other developers
- Comfort leading complex, high-impact frontend work end-to-end
